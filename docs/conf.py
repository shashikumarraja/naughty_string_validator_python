...
sys.path.insert(0, os.path.abspath('..naughty_string_validator/naughty_string_db'))
...
version = naughty_string_validator.__version__
# The full version, including alpha/beta/rc tags.
release = naughty_string_validator.__version__
...
htmlhelp_basename = 'naughty_string_validatordoc'
